    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i = 0; i < 10; i++) {
                ...
                double earthquakeMag = jsonObject.getJSONArray("features").getJSONObject(i).getJSONObject("properties").getDouble("mag");
                String earthquakeLocation = jsonObject.getJSONArray("features").getJSONObject(i).getJSONObject("properties").getString("place");
                long earthquakeTimeMs = jsonObject.getJSONArray("features").getJSONObject(i).getJSONObject("properties").getLong("time");
                String earthquakeUrl = properties.getString("url");

                Earthquake earthquake = new Earthquake(earthquakeMag, earthquakeLocation, earthquakeTimeMs, earthquakeUrl);
